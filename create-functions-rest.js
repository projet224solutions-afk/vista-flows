/**
 * 🔧 CRÉATION DES FONCTIONS VIA API REST SUPABASE
 * 
 * Ce script utilise l'API REST de Supabase pour créer les fonctions
 * en utilisant l'endpoint SQL.
 * 
 * @author 224SOLUTIONS
 * @version 1.0.0
 */
...
console.log('🔧 CRÉATION DES FONCTIONS VIA API REST SUPABASE');
...
// ===================================================
// EXÉCUTION DES FONCTIONS VIA API REST
// ===================================================
...
async function createSupabaseFunctions() {
    ...
    for (const func of functions) {
        try {
            ...
            const result = await executeSQLViaREST(func.sql);
