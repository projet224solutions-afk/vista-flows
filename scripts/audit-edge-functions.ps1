$invoked = @(
  ...
  "dispute-resolve","dispute-respond","djomy-init-payment","djomy-verify","escrow-create","escrow-create-stripe",
  ...
  "djomy-init-payment","paypal-client-id","create-paypal-order","generate-contract-pdf","create-contract",
  ...
  "escrow-auto-release","escrow-stripe-webhook","subscription-webhook","stripe-webhook","djomy-webhook",
  "chapchappay-webhook","djomy-secure-webhook","paypal-webhook","stripe-deposit","stripe-pos-payment",
  ...
  "cognito-auth-proxy","assess-payment-risk","mobile-money-withdrawal","djomy-init-payment",
  "djomy-payment","change-agent-email","change-agent-password","reset-pdg-password",
