-- Amélioration du système Escrow avec logs et automation
...
BEGIN
  ...
  -- Récupérer wallet PDG (escrow holding account)
  ...
  -- Créditer le wallet escrow (PDG holding)
...
BEGIN
  ...
  -- Créer wallet receiver si n'existe pas
  ...
  -- Débiter wallet escrow (PDG holding)
  IF v_pdg_wallet_id IS NOT NULL THEN
    UPDATE public.wallets
