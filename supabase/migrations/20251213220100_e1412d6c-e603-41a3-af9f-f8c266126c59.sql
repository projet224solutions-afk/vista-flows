-- Créer les fonctions SECURITY DEFINER pour la gestion des membres du bureau syndicat
-- Pattern identique à add_vehicle_for_bureau pour contourner les RLS

-- Fonction pour créer un membre du bureau
...
-- Fonction pour mettre à jour un membre du bureau
...
-- Fonction pour supprimer un membre du bureau
...
BEGIN
    ...
    DELETE FROM public.syndicate_worker_permissions
