-- Fonction pour prévisualiser un transfert wallet avec calcul des frais
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM wallets WHERE user_id = p_receiver_id AND currency = p_currency) THEN
