...
DROP POLICY IF EXISTS "Bureau workers view own bureau" ON public.bureaus;
...
DROP POLICY IF EXISTS "Workers view own data" ON public.syndicate_workers;
...
DROP POLICY IF EXISTS "Bureau workers view wallet" ON public.bureau_wallets;
