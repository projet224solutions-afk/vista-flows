-- Corriger handle_new_user pour bien bypasser RLS
...
BEGIN
  ...
  -- Insérer le profil - SECURITY DEFINER bypass automatiquement RLS
...
COMMENT ON FUNCTION handle_new_user() IS 'Crée automatiquement un profil pour chaque nouvel utilisateur avec SECURITY DEFINER pour bypass RLS';
