-- Drop ALL versions of create_escrow_transaction function to resolve overloading issue
DROP FUNCTION IF EXISTS public.create_escrow_transaction CASCADE;
...
BEGIN
  ...
  -- Log the escrow creation using correct column names
