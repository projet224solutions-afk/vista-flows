-- Fix the record_subscription_payment function to use price_paid_gnf
...
BEGIN
  ...
  -- Insert new subscription with price_paid_gnf (the correct column name)
...
-- Also drop the price_paid column if it exists (it was incorrectly added)
