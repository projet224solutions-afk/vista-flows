-- Corriger les fonctions avec SET search_path pour la sécurité

-- Fonction pour obtenir le taux de commission (sécurisée)
...
-- Fonction de prévisualisation du transfert (sécurisée)
...
-- Mise à jour de la fonction process_wallet_transaction (sécurisée)
