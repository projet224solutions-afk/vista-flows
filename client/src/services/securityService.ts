...
<<<<<<< HEAD:src/services/securityService.ts
    const cryptoBytes = window.crypto.getRandomValues(new Uint8Array(16));
    const cryptoString = Array.from(cryptoBytes, byte => byte.toString(36)).join('');
=======
...
>>>>>>> 33b42bafcc846916b3f76992c9af5e7e0240830e:client/src/services/securityService.ts
