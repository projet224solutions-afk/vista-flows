    ...
    <div className="fixed inset-0 bg-background flex flex-col z-[200]">
      ...
      <div className="flex items-center gap-3 p-4 border-b border-border bg-card/95 backdrop-blur-sm shadow-sm">
        ...
        <div className="relative">
          ...
          {isRecipientOnline && (
            <span className="absolute bottom-0 right-0 w-3.5 h-3.5 rounded-full bg-primary-blue-600 border-2 border-card" />
          )}
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5">
            {isRecipientTyping ? (
              ...
              <>
                <span className="w-2 h-2 rounded-full bg-primary-blue-600" />
