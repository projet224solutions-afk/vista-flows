...
const SYSTEM_FEATURES = [
  { name: 'Authentification S̩curis̩e', icon: Lock, color: '#22c55e', domain: 'AUTH' },
  ...
  { name: 'Syst̬me POS', icon: ShoppingCart, color: '#06b6d4', domain: 'POS' },
  ...
  { name: 'Base de Donn̩es', icon: Database, color: '#14b8a6', domain: 'DATABASE' },
