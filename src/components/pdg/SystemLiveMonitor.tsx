          ...
          <div className="relative flex-1 p-3 sm:p-6 overflow-y-auto overflow-x-hidden" ref={containerRef}>
            ...
            <div className="relative z-10 flex justify-center">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-8 p-3 sm:p-6 rounded-xl sm:rounded-2xl bg-primary-blue-500/20 border border-primary-orange-500/30 w-full sm:w-auto"
              >
